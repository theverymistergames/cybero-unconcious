...
[Serializable, VolumeComponentMenu("Post-processing/Custom/ZoomBlur")]
public sealed class ZoomBlur : CustomPostProcessVolumeComponent, IPostProcessComponent {
    ...
    public override void Setup() {
        if (Shader.Find("Hidden/Shader/ZoomBlur") != null)
            m_Material = new Material(Shader.Find("Hidden/Shader/ZoomBlur"));
    }
